...
export default function AccountPage() {
  ...
  //to check if passwords match on change, better experience for client-side validation
  const password1 = watch('password1');
  const password2 = watch('password2');

  useEffect(() => {
    if (password2) trigger('password2');
  }, [password2, password1, trigger])
  ...
  return (
    <Segment>
      ...
      <div>
        ...
        <p>Visit GitHub to change your account settings</p>
      ...
      <div>
        ...
        <p>Visit Google to change your account settings</p>
        <Button as={Link} to='https://google.com/' color='google plus'>
          <Icon name='github' /> Go to Google
        </Button>
      </div>
      }
